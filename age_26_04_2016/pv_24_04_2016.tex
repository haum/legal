...
pas conséquent pas compté dans le quorum. Il ne donne pas accès aux 
...
dans le règlement intérieur}{17}{17}{0}{0}

\section{Modification du bureau}

Il est proposé de ne pas dissoudre l'actuel bureau de l'association mais 
de procéder à l'inclusion des volontaires et la re-répartition des rôles 
au sein de celui-ci.
