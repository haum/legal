...
\vote{Accorder le droit de vote aux non-membres présents}{14}{14}{0}{0}
...
\emph{membre sympathisant} accessible par une cotisation de 10 euros ou 
...
d'aider le HAUM via une augmentation de la base de membres et 
...
L'adhésion de personnes morales sous le statut de \emph{membre partenaire} est 
désormais possible pour une adhésion minimale de 90 euros. La possibilité 
...
\section{Redéfinition du quorum}

Compte tenu de la difficulté grandissante à réunir les deux tiers des membres (quorum actuel) pour prendre les décisions relevant de la vie associative, il est proposé par l'actuel bureau d'abaisser le quorum à la moitié des membres actifs plus un.

\vote{Passage à la majorité absolue des votants pour atteindre le quorum}{17}{17}{0}{0}

\section{Droit à l'image des membres}

Dans le cadre de la communication externe du HAUM, il peut être 
nécessaire de publier des photos et des vidéos contenant l'image de 
certains des membres de l'association. À ce titre, il est demandé aux 
membres de voter pour l'inclusion au règlement intérieur d'un article 
autorisant le HAUM à utiliser l'image de ses membres dans sa 
...
redéposés en Préfecture une fois les modification incluses. 
