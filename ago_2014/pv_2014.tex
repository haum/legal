...
L'association n'ayant plus de liens direct avec l'université du Maine et son nom étant jugé trop restrictif, il est proposé de changer la signification de l'acronyme utilisé. Le nom suggéré par un grand nombre de membre est \textit{Hackerspace AU Mans}.
...
Afin de centraliser les informations concernant notamment l'organisation et la communication extérieure et intérieure sur les événements en lien avec le HAUM, il est proposé de nommer tacitement une personne en  charge de ce travail. Fred BLAIN se désigne et est accepté par l'assemblé à ce poste.
...
La cotisation est donc fixée à 20EUR, avec incitation aux dons.
...
\vote{J. Bréhéret au poste de secrétaire}{7}{7}{0}{0}
